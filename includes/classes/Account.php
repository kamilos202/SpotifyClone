<?php
	class Account {
		...
		public function __construct($con) { //first to be called
			$this->con = $con;
		...
		private function validateUsername($un) {
			...
			if(mysqli_num_rows($checkUsernameQuery) != 0){	// username already exists
		...
		private function validateEmails($em, $em2) {
			...
			if(mysqli_num_rows($checkEmailQuery) != 0){	// username already exists
